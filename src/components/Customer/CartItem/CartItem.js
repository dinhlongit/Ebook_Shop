...
import {addProductToCart, decrementCartQuantity, incrementCartQuantity, removeProductToCart} from "../../../actions/cart";
    ...
    return (
        <div className="row align-items-center mb-3">
            <div className="col-12 col-sm-12 col-md-2 text-center">
                <img className="img-responsive" src={`${SERVER_IMAGE}${photo}`} style={{height: '60%', width: '60%'}} alt={description}
                 />
            </div>
